...
$address = "seikotsuin.ren@gmail.com";
$footer_text = "整骨院れん
所在地：〒887-0015 宮崎県日南市大字平野2766
電話番号:0987-67-6777
営業時間：9:00～12:00 15:00～20:00 (土曜日：9:00~13:00)
定休日：日・祝・土曜午後（土曜診療 13時迄）
URL:https://seikotsuin-ren.com/
";
...
$site_top = "https://miyazaki-ren.com/contact/thanks/";

//管理者のメールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "seikotsuin.ren@gmail.com";
...
$BccMail = "kunitake.higoone@gmail.com";

// 管理者宛に送信されるメールのタイトル（件名）
$subject = "整骨院れん 美容鍼 WEB予約";
...
$thanksPage = "https://miyazaki-ren.com/contact/thanks/";
...
$require = array('お名前','メールアドレス','電話番号','第一ご予約希望日','第一ご予約希望時間','当院を知ったきっかけ');
